...
| Work-state transfer schema | ⚠️ LOW | Schema novel, concept obvious |
| Lifecycle-aware project intelligence | ⚠️ MEDIUM | Formalization novel, concept intuitive |
...
| Accountability layer | ⚠️ LOW | NIST/IBM/InterSAGE already propose |
...
| Agent gateways with standing | ⚠️ RISING | AgentCore, Databricks, agentgateway.dev already do admission control; risk of commoditization |
